...
csv_file = os.path.join(BASE_DIR, 'data', 'company_cluster.csv')
...
def load_dataset():
    ...
    try:
        ...
        print(f"Dataset loaded: {len(company_cluster_df)} rows.")
...
def search():
    ...
    if request.method == "POST":
        ...
        if not skill_input:
            ...
            if company_cluster_df is not None and not company_cluster_df.empty:
